...
export default function Autres() {
  return (
    <>
      <section className={`${styles.prestationBlock} ${styles.bgAlt}`}>
        <PrestationPage
          heroCollapsible
          heroAlign="left"
              ...
              content: (
                <>
                  <p>
                    ...
                    <strong>partager</strong> des expériences et de repartir
                    avec des outils simples et efficaces. Et si, en plus, vous y
        ...
        />
        {/*} <div className={styles.prestationDivider} />*/}
      </section>
      <section className={styles.prestationBlock}>
        <PrestationPage
          heroCollapsible
          heroAlign="right"
              ...
              content: (
                <>
                  <p>
                    ...
                    communication et la coopération. Espace confidentiel,
                    exigeant mais bienveillant, où l’on travaille sur la
                    posture, la confiance, la gestion des conflits et la clarté
                    mentale.
                  </p>
                </>
              ),
              ...
              content: (
                <>
                  <p>
                    ...
                    expertise à un public plus large autour d’une thématique où
                    le fond est solide, le ton accessible, et l’émotion bien
                    présente.
                    <br />
                    <br /> Je construis des interventions sur mesure dès lors
                    que le sujet entre dans mon champ de compétences. Demandez
                    moi : je vous répondrai en toute transparence sur la
          ...
          sections={[
            ...
            },
            {
              ...
              content: (
                <>
                  <p>
                    Pour des formations dynamiques, humaines, ancrées dans le
                    réel et parce que le savoir est fait pour circuler.
                    <br />
                    <em>
